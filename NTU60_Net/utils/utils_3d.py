...
def group_points_4DV_T_S(points, opt):
    ...
    if(1==1):
        ...
        dis_l=dis_l.sum(3).unsqueeze(3)#lx#The distance of each point from the origin in local coordinates(B*F)*64*32*1
...
def group_points_4DV_T_S2(points, opt):
    ...
    # print(cur_train_size*opt.framenum,opt.T_sample_num_level2,opt.T_knn_K2,points.shape[-1])
