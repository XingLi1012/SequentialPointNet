...
class PointNet_Plus(nn.Module):
    ...
    def forward(self, xt, yt):
        #Intra-frame appearance encoding module
        #set abstract 1-improved pointnet
        ...
        #Inter-frame motion encoding module
        ...
        ####Hierarchical pyramid max pooling layer
